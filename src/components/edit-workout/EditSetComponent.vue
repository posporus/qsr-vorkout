<template>
  <div class="sets">
    ...
    >
        ...
        <switchable-panel v-model="expanded">
          <template v-slot:true>
            <q-item-section avatar>
              <number-spinner v-model="set.sets"> x </number-spinner>
            </q-item-section>

            <q-item-section>
              <q-input label="Name(optional)" v-model="set.name"> </q-input>
            </q-item-section>
          </template>
      ...
      -->
        <edit-exercise
          v-for="(exercise, index) in set.exercises"
          :key="index"
          :_exercise="exercise"
        />
...
import EditExercise from 'components/EditExerciseComponent.vue'
import { Set } from 'src/classes'
import { NumberSpinner } from 'src/components/ui'
import { SwitchablePanel } from 'src/components/ui'
